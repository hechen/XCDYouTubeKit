...
- (void) startNextRequest
{
	...
	else
	{
        ...
        NSString *urlString = [NSString stringWithFormat:@"https://youtubei.googleapis.com/youtubei/v1/player?key=%@", XCDYouTubeClient.innertubeApiKey];
                 ...
                 NSString *string = [NSString stringWithFormat:@"{'context': {'client': {'hl': 'en','clientName': 'IOS','clientVersion': '2.20210721.00.00','mainAppWebInfo': {'graftUrl': '/watch?v=%@'}}},'videoId': '%@'}", self.videoIdentifier, self.videoIdentifier];
